...
// Environmental Goals — TerminalUI
      ...
      <div style={{ display: "grid", gridTemplateColumns: showForm ? "1fr minmax(300px, 380px)" : "1fr", gap: "var(--space-6)" }}>
        <div>
          ...
          {loading ? (
            <div style={{ padding: "var(--space-8)", textAlign: "center" }}>
              ...
              <span style={{ marginLeft: "var(--space-3)", fontFamily: "var(--font-mono)" }}>LOADING GOALS...</span>
            </div>
          ) : items.length === 0 ? (
              ...
              {items.map((goal) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "var(--space-4)",
                    background: editingId === goal.id ? "rgba(0, 255, 65, 0.04)" : "var(--color-surface)",
                  }}
                >
                  ...
                  {goal.description && (
                    <div style={{ fontFamily: "var(--font-mono)", fontSize: "12px", color: "var(--color-text-muted)", marginBottom: "var(--space-3)" }}>
                      {goal.description}
                    </div>
                  )}
                  ...
                  <div style={{ display: "flex", gap: "var(--space-2)", alignItems: "center", flexWrap: "wrap" }}>
                    <span style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "var(--color-text-dim)" }}>update current:</span>
                    <input
                      className="form-input"
                      style={{ width: "120px", paddingLeft: "12px", height: "32px" }}
                      type="number"
                      step="any"
                    ...
                    {goal.created_by_name && (
                      <span style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "var(--color-text-dim)", marginLeft: "auto" }}>
        ...
        {showForm && (
          <div className="card-elevated" style={{ height: "fit-content" }}>
            <div className="card-header">{editingId ? `EDIT GOAL #${editingId}` : "NEW ENVIRONMENTAL GOAL"}</div>
            <form onSubmit={handleSubmit}>
              <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
                <div className="form-group">
                  <label className="form-label" htmlFor="g-name">NAME</label>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-3)" }}>
                  <div className="form-group">
                    <label className="form-label" htmlFor="g-target">TARGET</label>
                    <div className="input-wrapper">
                      <span className="input-prompt">&gt;</span>
                  ...
                  <div className="form-group">
                    <label className="form-label" htmlFor="g-unit">UNIT</label>
                    <div className="input-wrapper">
                      <span className="input-prompt">&gt;</span>
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="g-deadline">DEADLINE</label>
                  <input id="g-deadline" type="date" className="form-input" value={form.deadline} onChange={(e) => setForm({ ...form, deadline: e.target.value })} required disabled={submitting} style={{ paddingLeft: "12px" }} />
                </div>
                <div className="form-group">
                  <label className="form-label" htmlFor="g-status">STATUS</label>
                  <select id="g-status" value={form.status} onChange={(e) => setForm({ ...form, status: e.target.value })} style={selectStyle} disabled={submitting}>
