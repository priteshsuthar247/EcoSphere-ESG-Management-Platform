...
- Gamification: Challenges, badges, XP, rewards and leader boards
...
| ------------------- | --------------------------------------- | ----------------------------------------------------------- |
| **Department**      | Organizational hierarchy and ESG        | Name, Code, Head, Parent Department, Employee Count, Status |
| **Category**        | Shared category values used across      | Name, Type (CSR Activity / Challenge), Status               |
...
**_8._** **_Core_** **_Conﬁguration_** **_&_** **_Business_** **_Rules_**
